...
export default function Workflow() {
  ...
  const workflowTabs = [
    ...
    // { perm: "admittance-workflow", label: "Admittance", component: <AdmittanceWorkflow /> },
    // { perm: "billing-workflow", label: "Billing", component: <BillingWorkflow /> },
  ...
  return (
    <div className="container-col">
      ...
      {/* Content */}
      <div className="p-4 border border-gray-blue-100 rounded-lg">
        {availableTabs.find((tab) => tab.label === activeTab)?.component || (
